    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salary_rating', models.PositiveIntegerField(default=0)),
                ('location_rating', models.PositiveIntegerField(default=0)),
                ('culture_rating', models.PositiveIntegerField(default=0)),
                ('leadership_rating', models.PositiveIntegerField(default=0)),
                ('team_rating', models.PositiveIntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interview_prep_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobseekerapi.interviewprep')),
            ],
        ),
        migrations.AddField(
            model_name='boardjob',
