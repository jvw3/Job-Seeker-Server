# Generated by Django 4.1.3 on 2022-12-13 14:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(related_name='tags_from_seeker', through='jobseekerapi.BoardJobTag', to='jobseekerapi.tag')),
        ...
        migrations.AddField(
            model_name='boardjobtag',
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobseekerapi.tag'),
        ),
        migrations.AddField(
            model_name='boardjob',
            name='category',
